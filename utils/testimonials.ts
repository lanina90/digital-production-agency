export const testimonials = [
  ...
  },
  {
    ...
    photo: "/images/testimonials/mark.jpg"
  },
  {
    id: 4,
    title: "ProTech Solutions turned to SquareUp to automate our workflow",
    text: "They delivered an exceptional custom software solution. The system has significantly increased our productivity and reduced manual errors. SquareUp' expertise and professionalism have made them a trusted technology partner.",
    name: "Laura Adams",
