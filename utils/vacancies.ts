export const vacancies= [
  {
    ...
    vacancies: [
      {
        id: 1,
        icon: "/images/vacancy/ui-designer.svg",
        name: "UI Designer",
      ...
      {
        id: 2,
        icon: "/images/vacancy/ux-designer.svg",
        name: "UX Designer",
      ...
      {
        id: 3,
        icon: "/images/vacancy/design-head.svg",
        name: "Design Head",
  ...
  },
  {
    ...
    vacancies: [
      {
        id: 1,
        icon: "/images/services/engineering/html.svg",
      ...
      {
        id: 2,
        icon: "/images/services/engineering/backend.svg",
      ...
      {
        id: 3,
        icon: "/images/services/engineering/cms.svg",
  ...
  },
  {
    ...
    vacancies: [
      {
        id: 1,
        icon: "/images/services/pm/updates.svg",
        name: "BA Manager",
      ...
      {
        id: 2,
        icon: "/images/services/pm/scrum.svg",
      ...
      {
        id: 3,
        icon: "/images/vacancy/hr-manager.svg",
        name: "HR Manager",
  ...
  },
  {
    ...
    vacancies: [
      {
        id: 1,
        icon: "/images/services/pm/bug.svg",
        name: "QA Tester",
      ...
      {
        id: 2,
        icon: "/images/services/pm/performance.svg",
        name: "SQL Tester",
      ...
      {
        id: 3,
        icon: "/images/services/pm/testing.svg",
        name: "Manual Tester",
